...
st.set_page_config(
    ...
    page_icon=r"C:\Users\SubrahmanyamPillalam\Downloads\Chatbot\IT logo.png",
    layout="wide"
)
...
def main():
    ...
    with left_col:
        st.image(
            r"C:\Users\SubrahmanyamPillalam\Downloads\Chatbot\download (2).png",
            width=120
        )
